 ...
 */
  ...
  class formContactPlugin extends BaseApplicationPlugin {
		# -------------------------------------------------------
		public function __construct($ps_plugin_path) {
			$this->description = _t('Adds contact form to pawtucket');
			
			$this->opo_config = Configuration::load($ps_plugin_path.'/conf/formContact.conf');
			parent::__construct();
		}
		# -------------------------------------------------------
		/**
